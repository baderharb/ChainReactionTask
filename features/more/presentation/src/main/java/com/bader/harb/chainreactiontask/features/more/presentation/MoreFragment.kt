package com.bader.harb.chainreactiontask.features.more.presentation
...
import com.bader.harb.chainreactiontask.features.more.presentation.databinding.FragmentMoreBinding
...
class MoreFragment : Fragment() {
    ...
    private fun clearPreferences() {
        prefs.clearPrefs()
        findNavController().navigate(R.id.navigation_fragment_login)
    }
}