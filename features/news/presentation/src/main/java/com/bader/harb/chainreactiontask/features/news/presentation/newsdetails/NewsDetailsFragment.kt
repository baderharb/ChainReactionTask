package com.bader.harb.chainreactiontask.features.news.presentation.newsdetails
...
import com.bader.harb.chainreactiontask.features.news.presentation.databinding.FragmentNewsDetailsBinding
...
class NewsDetailsFragment : Fragment() {
    ...
    private fun initClicks() {
        ...
        binding.imageViewShare.setOnClickListener {
            shareContent(
                link = newsListModel?.url.toString(),
                title = newsListModel?.title.toString()
            )
        }
    }
