...
import com.bader.harb.chainreactiontask.features.news.domain.usecase.NavFromNewsListToNewsDetailsUseCase
import com.bader.harb.chainreactiontask.features.news.domain.usecase.PopularNewsUseCase
...
class NewsViewModel @Inject constructor(
    ...
    fun navigateToNewsDetails(currentFragment: Fragment, newsListModel: NewsListModel?) {
        navFromNewsListToNewsDetailsUseCase(
            currentFragment = currentFragment, newsListModel = newsListModel
        )
    }
}